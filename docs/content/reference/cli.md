...
```
randomuser <command> [arguments] [flags]
```

Run `randomuser <command> --help` for the full flag list on any command. This
...
per operation you declare in `randomuser/domain.go`.
